...
}, BFHTimePickerDelimiter = ":", BFHTimePickerModes = {
    am: "AM",
    pm: "PM"
}, BFHTimezonesList = {
    AF: {"Asia/Kabul": "Kabul"},
...
+function (a) {
    ...
    b.prototype = {
        constructor: b, getCountries: function () {
            ...
            for (b in c)c.hasOwnProperty(b) && this.$element.append('<option value="c[b]">' + c[b] + "</option>");
            this.$element.val(a)
    ...
    function e(a, b, c) {
        var d, e, f;
        d = [{part: "m", position: a.indexOf("m")}, {part: "y", position: a.indexOf("y")}, {
            part: "d",
    ...
    b.prototype = {
        constructor: b, getFonts: function () {
            ...
            } else for (b in BFHGoogleFontsList.items)BFHGoogleFontsList.items.hasOwnProperty(b) && (c[BFHGoogleFontsList.items[b].family] = {
                info: BFHGoogleFontsList.items[b],
                index: parseInt(b, 10)
            });
            return c
